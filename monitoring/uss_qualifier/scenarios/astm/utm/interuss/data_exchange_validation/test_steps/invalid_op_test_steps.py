...
def plan_flight_intent_expect_failed(
    ...
    return submit_flight_intent(
        ...
        test_step,
        "Plan should fail",
        {InjectFlightResponseResult.Failed},
        {
            InjectFlightResponseResult.Planned: "Failure If Planned",
            InjectFlightResponseResult.ConflictWithFlight: "Failure If Conflict",
            InjectFlightResponseResult.Rejected: "Failure If Rejected",
        },
        flight_planner,
        flight_intent,
    )[0]
