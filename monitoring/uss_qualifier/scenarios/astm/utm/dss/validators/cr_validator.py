...
class ConstraintReferenceValidator:
    ...
    def __init__(
        ...
        self._expected_start = cr_params.extents[0].time_start.value.datetime
        self._expected_end = cr_params.extents[-1].time_end.value.datetime
    ...
    def validate_fetched_cr(
        ...
        self._validate_cr(
            expected_entity_id=expected_cr_id,
            dss_cr=parsed_resp.operational_intent_reference,
            t_dss=t_dss,
            previous_version=None,
