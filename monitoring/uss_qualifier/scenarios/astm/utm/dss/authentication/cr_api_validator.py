...
class ConstraintRefAuthValidator:
    ...
    def _verify_cr_creation(self):
        ...
        self._current_cr = oir_resp.constraint_reference
    ...
    def _verify_cr_mutation(self):
        ...
        self._current_cr = parsed_oir.constraint_reference
    ...
    def _sanity_check_oir_not_updated(
        ...
        try:
            oir, sanity_check = self._dss.get_constraint_ref(self._test_id)
            self._scenario.record_query(sanity_check)
            if (
                abs(
