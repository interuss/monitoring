...
class OIRImplicitSubHandling(TestScenario):
    ...
    def run(self, context: ExecutionContext):
        ...
        self.begin_test_case(
            "Implicit subscriptions are properly mutated upon OIR mutation"
        )
        ...
        #  - update and mention implicit sub params -> existing sub is either mutated or removed and another one created
        ...
        with self.check(
            ...
            try:
                oir, subs, q = self._dss.put_op_intent(
                    ...
                    ovn=self._oir_b_ovn,
                    # We want to observe the behavior if the request contains the implicit sub
                    # params.
