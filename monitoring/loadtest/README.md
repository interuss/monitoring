...
See [benchmarker background](../benchmarker/README.md#background) for general background of performance measurement.  When using LoadTest to measure performance, the procedure used should generally attempt to measure left side of the curve and avoid drawing conclusions from measurements of the right (wrong) side of the curve.
